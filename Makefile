...
LIBSRCS_STANDALONE := src/methods.c src/stdlib.c src/json_parse.c src/table_xml.c src/cli_main.c src/input.c src/isolde_bridge.c src/lissen.c src/govee.c src/rest.c src/graph.c src/machine.c
